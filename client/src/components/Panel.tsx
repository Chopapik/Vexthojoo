        ...
        <>
          ...
          <div className="w-screen h-screen fixed flex justify-center">
            <div className="fixed mt-[300px] pl-[2px] pb-[2px] flex justify-end bg-neutral-700">
              <div className="bg-neutral-800 text-white min-h-[200px] w-[300px] md:min-w-[450px] py-2 px-4">
                <div className="absolute flex justify-end bg-neutral-600 hover:bg-red-900 pl-[2px] pb-[2px] top-1 right-1 transition-all ease-in duration-2">
                  <button
