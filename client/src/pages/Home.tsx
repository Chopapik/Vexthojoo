      ...
      <div className="w-full flex space-x-5 flex-col items-center lg:flex-row lg:items-start">
        <main className="w-full lg:w-2/3 flex flex-col items-center">
          <div className="md:p-3 py-4 space-y-3 w-full sm:w-[640px] md:max-w-none flex flex-col items-center">
            <div
              className="bg-neutral-900 px-5 border-l-8 border-t border-neutral-800 border-t-neutral-800 w-3/4 py-3 font-poppins cursor-pointer hover:border-l-customCyan-light box-border transition-colors ease-in-out duration-300"
              onClick={() => {
        ...
        <aside className="w-full lg:w-1/3 max-h-[75vh] lg:sticky lg:top-[60px] flex flex-col items-center px-5 space-y-10 max-w-[400px] ">
